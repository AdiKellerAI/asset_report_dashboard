...
# the same number as gross_rent. "Balance" (net_to_adi = NOI + unpaid_bills
# - mortgage, labeled "Balance" on the Dashboard/Report pages) is
# deliberately not offered here (Adi's request, 2026-08-26) -
...
def report_breakdown(session, month, property_nickname="all"):
    ...
    waterfall.append({"label": "Balance", "start": 0, "end": net_cash_flow, "kind": "total"})
