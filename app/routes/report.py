...
from app.reports import available_report_months, latest_reported_month, report_breakdown
...
def report():
    ...
    try:
        ...
        if month_param:
            ...
            selected_month = latest_reported_month(session) or date.today().replace(day=1)
